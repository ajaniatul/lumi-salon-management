...
<div class="page">
  <div class="hdr">
    ...
    <div class="hdr-contact">
      ...
      Tel: ${d.brandPhone || "022-12345678"} / 9995818169 &nbsp;·&nbsp; ${d.brandEmail || "hello@lumisalon.in"} &nbsp;·&nbsp; ${d.brandWebsite || "www.lumisalon.in"}
    </div>
  </div>
  ...
  <div class="ftr">
    ...
    <div class="ftr-sub">
      ...
      For queries, reach us at ${d.brandPhone || "022-12345678"} / 9995818169 or ${d.brandEmail || "hello@lumisalon.in"}
    </div>
  </div>
  </div>
</div>
        ...
        <div style={{
          ...
          <div style={{ background:"#fafafa", borderTop:"1px solid #e5e5e5", padding:"18px 44px", textAlign:"center" as const }}>
            ...
            <p style={{ fontSize:"9.5px", color:"#9A7A80", lineHeight:"1.7" }}>
              This is a computer-generated invoice and does not require a signature.<br />
              For queries, reach us at {data.brandPhone || "022-12345678"} / 9995818169 or {data.brandEmail || "hello@lumisalon.in"}
            </p>
          </div>
        </div>
      </div>
