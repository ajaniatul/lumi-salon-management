      ...
      >
        ...
        <div className="relative z-10 text-center max-w-md">
          ...
          <p className="text-sm leading-relaxed"
            style={{ color: "#9A7A80" }}>
            Streamline appointments, billing, inventory, and staff management from a single premium platform.
          </p>
        ...
        <div className="absolute bottom-8 flex items-center gap-2"
          ...
          <span className="text-xs">Formerly associated with Lakmé</span>
          <Sparkles className="w-3.5 h-3.5" />
        </div>
      </div>
